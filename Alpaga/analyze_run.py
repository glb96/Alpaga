...
def averaging_and_cleaning(name_file, N_iter, extention='.dat', fct_name=standard_file_name, type_cleaning='mean', L_mean_cleaning_n=[1, 1, 1, 3], L_mean_cleaning_evo_max=[2, 1.5, 1.4, 1.3], show_spectra='average', figure_counter=1):
    ...
    *N_iter* set how many acquisitions has to be averaged. If *N_iter* is an int, the i goes from 1 to N_iter. If it is a list, the averaging is made over the iteration present in the list. Example: N_iter = [1, 3, 5] would average the acquisition 1, 3 and 5.
    ...
    fct_name : function
        [Optional] The function used to built the name of a file given the prefixe, angle, iteration and extention. By default, the alpaga.standard_file_name function is used. 
    type_cleaning: str
...
def fit_gaussian_from_noise(L_x, L_y, l_cut=[380, 395, 419, 433], order_fit_noise=4, method_fit='fit_gauss', bounds_fit_gausse=([0, 395, 1], [np.inf, 410, 25]), lambda_0_ref=403, waist_ref=2, exclu_zone=False, fit_noise= False, show_spectra='all', figure_counter=1):
    ...
    ::
        ...
        L_lambda, L_spectra, _ = alpaga.averaging_and_cleaning(names, N_iter, extention='.dat', type_cleaning='mean', L_mean_cleaning_n=[1, 1, 1, 3], L_mean_cleaning_evo_max=[2, 1.5, 1.3, 1.3], show_spectra=False, figure_counter=1)
...
def polarisation_intensity(directory=False, prefix_file=False, L_files_angles=False, N_iter=False, extention='.dat', fct_name=standard_file_name, type_cleaning='mean', L_mean_cleaning_n=[1, 1, 1, 3], L_mean_cleaning_evo_max=[2, 1.5, 1.4, 1.3], automatic_l_cut=False, l_cut=[380, 395, 419, 433], l_cut_n_n2=[2, 9], order_fit_noise=4, method_fit_first='fit_gauss', bounds_fit_gausse=([0, 395, 1], [np.inf, 410, 25]), lambda_0_ref=403, waist_ref=2, exclu_zone=False, fixed_para_gauss_fit=True, method_fit_second='fit_gauss', save_result=True, name_save_result='./post_prod_results.p', waiting_time=False):
    ...
    L_post_prod['extention'] = extention

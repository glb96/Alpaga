...
Up-to-date, about a dozen scientists have used `Alpaga` to treat experimental data. The code have been successfully used in multiple scientific communications and publications already [@le2022second, @le2023liquid, @le2024microscopic, @rondepierre2025correlations, @fery2025sonder, @fr1, @fr2 ]. 

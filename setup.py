...
#    long_description_content_type="text/markdown",
    ...
    package_data={'': ['Data_tutorial/SHS/Eau_polar_V/*.dat', 'Data_tutorial/SHS/Single_angle/*.dat', 'Data_tutorial/SHS/*.p', 'Data_tutorial/SSHG/*.p', 'Data_tutorial/Exclu_zone/*.p', 'Data_tutorial/Exclu_zone/*.dat']},
    classifiers=[
